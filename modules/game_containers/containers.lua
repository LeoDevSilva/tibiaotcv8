...
function onContainersUpdate(container)
	...
	print("Teste de onContainersUpdate.")
...
local function setRarityFrames()
  for _, container in pairs(g_game.getContainers()) do
    ...
    for i, child in pairs(window:getChildren()) do
      ...
      if name and not name:match("^%s*$") then
        ...
        if string.find(lowerName, "mythic") then
          child:setImageSource('/images/ui/rarity_red')
        elseif string.find(lowerName, "legendary") then
        ...
        elseif string.find(lowerName, "rare") then
          child:setImageSource('/images/ui/rarity_green')
        elseif string.find(lowerName, "common") then
          child:setImageSource('/images/ui/rarity_blue')
        elseif string.find(lowerName, "normal") then
...
function addLootCategory()
	...
	print("addLootCategory:", addLootCategory)
